    ...
    <div className="relative min-h-screen bg-white px-[40px]">      {/* Fixed Background Image */}
      ...
      <section className="relative z-0 container mx-auto px-4 pt-16 flex justify-center">
        <div className="max-w-5xl flex flex-col items-center">
          ...
          <div class="w-[179px] h-10 pb-px bg-[#5b43dd] rounded-[100px] shadow-[0px_0px_18.100000381469727px_0px_rgba(117,90,255,1.00)] outline-1 outline-[#5b43dd] inline-flex flex-col justify-start items-start gap-2.5">
            <div class="self-stretch h-10 flex-1 p-4 bg-[#8a76f3] rounded-[100px] shadow-[inset_0px_-1px_5.099999904632568px_0px_rgba(114,89,243,0.06)] shadow-[inset_0px_1px_0.5px_0px_rgba(216,197,255,0.29)] inline-flex justify-center items-center gap-2.5">
              <div class="justify-start text-[#faf9fe] text-base font-bold font-['Space_Grotesk']">Mint your Project</div>
            </div>
          </div>
          </button>
